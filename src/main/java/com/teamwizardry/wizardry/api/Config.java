...
public class Config {
	//World Gen
	public static int manaPoolRarity, particlePercentage, underworld_id;
	...
	public static void initConfig(File configFile) {
		...
		underworld_id = config.get("World", "UnderlandDimensionID", 42, "If you have a dimension ID conflict with this mod and something else, change this number").getInt();
