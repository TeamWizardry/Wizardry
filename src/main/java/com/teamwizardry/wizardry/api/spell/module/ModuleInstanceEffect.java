...
public class ModuleInstanceEffect extends ModuleInstance {
	...
	public ModuleInstanceEffect(IModuleEffect moduleClass, ModuleFactory createdByFactory, String moduleName, ResourceLocation icon, ItemStack itemStack, Color primaryColor, Color secondaryColor,
