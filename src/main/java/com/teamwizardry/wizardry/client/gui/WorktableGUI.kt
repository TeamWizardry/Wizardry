...
//
//    protected static final Sprite SPRITE_BACKGROUND = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/table.png"), 512, 256).getSprite("");
//    protected static final Sprite SPRITE_SCROLL_END = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/scroll_end.png"), 9, 5).getSprite("");
//    protected static final Sprite SPRITE_SCROLL_MIDDLE = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/scroll_middle.png"), 1, 1).getSprite("");
//    protected static final Sprite SPRITE_SCROLL_BUTTON = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/scroll_button.png"), 7, 16).getSprite("");
//    protected static final Sprite SPRITE_BUTTON = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/button.png"), 32, 16).getSprite("");
//    protected static final Sprite SPRITE_BUTTON_DEACTIVATED = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/button_deactivated.png"), 32, 16).getSprite("");
//    protected static final Sprite SPRITE_BUTTON_PRESSED = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/button_pressed.png"), 32, 16).getSprite("");
//    protected static final Sprite SPRITE_BUTTON_HOVER = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/button_hover.png"), 32, 16).getSprite("");
//    protected static final Sprite SPRITE_PLUS_PAPER = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/plus_paper.png"), 69, 76).getSprite("");
//    protected static final Sprite SPRITE_BLANK_PAPER = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/blank_paper.png"), 69, 76).getSprite("");
//    protected static final Sprite SPRITE_TALL_PAPER = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/big_paper.png"), 89, 118).getSprite("");
//    protected static final Sprite SPRITE_HUGE_PAPER_1 = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/huge_paper_1.png"), 154, 155).getSprite("");
//    protected static final Sprite SPRITE_HUGE_PAPER_2 = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/huge_paper_2.png"), 154, 155).getSprite("");
//    protected static final Sprite SPRITE_GRID = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/grid.png"), 80, 156).getSprite("");
//    protected static final Sprite SPRITE_GRID_CELL = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/grid_cell.png"), 28, 28).getSprite("");
//
//    protected static final Sprite SPRITE_MODIFIER_BAR = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_bar.png"), 85, 14 + 1).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_BOX = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_box.png"), 168, 156).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_KNOB = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_knob.png"), 8, 8).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_MINUS = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_minus.png"), 14, 14).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_MINUS_DISABLED = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_minus_disabled.png"), 14, 14).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_MINUS_HOVER = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_minus_hover.png"), 14, 14).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_MINUS_PRESSED = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_minus_pressed.png"), 14, 14).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_PLUS = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_plus.png"), 14, 14).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_PLUS_DISABLED = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_plus_disabled.png"), 14, 14).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_PLUS_HOVER = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_plus_hover.png"), 14, 14).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_PLUS_PRESSED = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_plus_pressed.png"), 14, 14).getSprite("");
//    protected static final Sprite SPRITE_MODIFIER_VERTICAL_BAR = new Mosaic(new Identifier(
//            "wizardry:textures/gui/worktable/modifier_vertical_bar.png"), 2, 14).getSprite("");
//
//
//    protected static final Sprite ICON_HUMAN_TARGET = new Mosaic(new Identifier(
//            "wizardry:textures/gui/icons/human_target.png"), 32, 32).getSprite("");
//    protected static final Sprite ICON_ELECTRIC = new Mosaic(new Identifier(
...
//                    24,
//                    24);
//            Sprite sprite = new Mosaic(new Identifier(
