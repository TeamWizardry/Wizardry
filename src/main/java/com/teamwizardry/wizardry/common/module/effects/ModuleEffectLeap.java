...
public class ModuleEffectLeap extends ModuleEffect implements IOverrideCooldown {
	...
	public int getNewCooldown(@Nonnull SpellData data) {
		...
		double strength = getModifierPower(data, Attributes.INCREASE_POTENCY, 1, 10, true, true);
	...
	public boolean run(@Nonnull SpellData spell) {
		...
		if (!target.hasNoGravity()) {
			...
			target.fallDistance /= getModifierPower(spell, Attributes.INCREASE_POTENCY, 2, 20, true, true);
