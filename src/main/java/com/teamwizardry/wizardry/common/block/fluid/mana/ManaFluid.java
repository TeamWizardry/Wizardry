...
{
    @Override public Fluid getFlowing() { return ModFluids.FLOWING_MANA; }

    @Override public Fluid getStill() { return ModFluids.STILL_MANA; }
    ...
    @Override public Item getBucketItem() { return ModItems.manaBucket; }
    ...
    @Override protected BlockState toBlockState(FluidState state) { return ModBlocks.liquidMana.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state)); }
