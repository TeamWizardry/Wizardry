...
public class WisdomTree extends Tree {
	public static final TreeFeatureConfig WISDOM_TREE_CONFIG =
			(new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(ModBlocks.wisdomLog.get().getDefaultState()),
			...
			.foliageHeight(3)
			.ignoreVines()
			.setSapling((IPlantable) ModBlocks.wisdomSapling.get()).build();
