...
public class EntityHallowedSpirit extends EntityMob {
    ...
    public void onUpdate() {
        ...
        if (ticksExisted % ThreadLocalRandom.current().nextInt(100, 200) == 0)
            playSound(ModSounds.HALLOWED_SPIRIT_SOUNDS.get(ThreadLocalRandom.current().nextInt(5)), ThreadLocalRandom.current().nextFloat(), ThreadLocalRandom.current().nextFloat());
