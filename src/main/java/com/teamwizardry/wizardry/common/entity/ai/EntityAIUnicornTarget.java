...
public class EntityAIUnicornTarget extends EntityAIBase {
	/**
	...
	public EntityAIUnicornTarget(EntityCreature creature, boolean checkSight) {
		this(creature, checkSight, false);
	}

	public EntityAIUnicornTarget(EntityCreature creature, boolean checkSight, boolean onlyNearby) {
	...
	public EntityAIUnicornTarget setUnseenMemoryTicks(int p_190882_1_) {
