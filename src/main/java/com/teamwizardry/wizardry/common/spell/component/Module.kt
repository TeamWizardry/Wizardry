...
open class Module     //    public String getTranslationKey() { return "wizardry.spell." + pattern.getRegistryName() + ":" + name; }
//    public String getTranslationKey(String key) { return getTranslationKey() + "." + key; }
    ...
    val allAttributes: List<String?>
        get() = LinkedList<String>(attributeValues.keys)
    ...
    val attributes: List<String>
        get() = attributeValues.keys.stream().filter { attribute: String -> attributeValues[attribute]!!.size > 1 }
