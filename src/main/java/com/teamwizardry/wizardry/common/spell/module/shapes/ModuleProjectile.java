...
public class ModuleProjectile extends Module {
	...
	public NBTTagCompound getModuleData() {
		...
		compound.setDouble(Constants.Module.SPEED, attributes.apply(Attribute.SPEED, 0.1));
		compound.setInteger(Constants.Module.PIERCE, (int) attributes.apply(Attribute.PIERCE, 0));
		compound.setDouble(Constants.Module.SCATTER, attributes.apply(Attribute.SCATTER, 0));
		compound.setInteger(Constants.Module.PROJ_COUNT, (int) attributes.apply(Attribute.PROJ_COUNT, 1));
