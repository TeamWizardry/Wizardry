...
public class ProjectileEntity extends SpellEntity {
    ...
    public void onEntityUpdate() {
        ...
        for (int i = 0; i < 5; i++) {
            SparkleFX particle = Wizardry.proxy.spawnParticleSparkle(worldObj, posX, posY, posY, 1F, 0.5F, 20, true);
            particle.jitter(8, 0.1, 0.1, 0.1);
            particle.randomDirection(0.2, 0.2, 0.2);
        }
