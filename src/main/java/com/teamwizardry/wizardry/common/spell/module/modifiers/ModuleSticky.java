...
public class ModuleSticky extends Module implements IModifier, IRuntimeModifier {
	...
	private final int baseBurnout = 5;
	...
	public void apply(AttributeMap map) {
		...
		map.putModifier(Attribute.MANA, new AttributeModifier(Operation.ADD, attributes.apply(Attribute.MANA, baseCost), Priority.HIGH));
