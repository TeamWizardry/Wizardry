...
public class ModuleScatter extends Module implements IModifier {
	...
	public void apply(AttributeMap map) {
		...
		map.putModifier(Attribute.MANA, new AttributeModifier(Operation.MULTIPLY, 1.0));
		map.putModifier(Attribute.BURNOUT, new AttributeModifier(Operation.MULTIPLY, 1.0));
	}
