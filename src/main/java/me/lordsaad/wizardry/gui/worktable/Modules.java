...
public class Modules {
    ...
    public static class Modifiers {
        ...
        public static final Module STICK = new Module(ID++, 0, 0, "The spell will stick to the entity/block it comes in contact with.", new ResourceLocation(Wizardry.MODID, "textures/items/manaIconOutline.png"), MODIFIER, SpellIngredients.Modifiers.STICK);
