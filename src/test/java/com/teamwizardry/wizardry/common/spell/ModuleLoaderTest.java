...
public class ModuleLoaderTest {
    private final HashMap<ResourceLocation, Pattern> testPatterns = new HashMap<>();
    private List<Module> modules;

    private final ResourceLocation shapeLoc = new ResourceLocation(Wizardry.MODID, "test_shape");
    private final ResourceLocation effectLoc = new ResourceLocation(Wizardry.MODID, "test_effect");
